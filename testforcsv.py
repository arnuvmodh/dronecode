...
TELEMETRY_CSV = "/home/charity/unreal_share/CDHAM-DT-V26/Content/drone_positions.csv"
TELEMETRY_HZ = 5.0
DETECTION_CONF = 0.35
...
def telemetry_loop():
    ...
    while not shutdown_event.is_set():
        ...
        try:
            ...
            flying_state = (
                state_str(fs.get("state", "unknown"))
            ...
            battery_pct = safe_int(
                bat if isinstance(bat, dict) else {},
                "percent",
                0
            )
